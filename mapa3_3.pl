...
initMap:- 
   ...
   mine(init, OID_M3, 1, 1, [ no_destroy(['.']) ]),
	...
	createGameEntity(OID_AR2, ')', object, 1, 7, active, automaticArcher, 
			[name(arquero), solid(false), static(true), use_rule(norule),
			description('Arquero automatico del rey'), appearance(attribs(bold, yellow, default))]), 
	createGameEntity(OID_AR3, '(', object, 18, 3, active, automaticArcher, 
			[name(arquero), solid(false), static(true), use_rule(norule),
			description('Arquero automatico del rey'), appearance(attribs(bold, yellow, default))]), 
	createGameEntity(OID_AR4, ')', object, 20, 3, active, automaticArcher, 
			[name(arquero), solid(false), static(true), use_rule(norule),
			description('Arquero automatico del rey'), appearance(attribs(bold, yellow, default))]), 
	automaticArcher(init, OID_AR1, ['@'], right, 7, [ continuous, bullet_appearance('>', bold, red, default) ]),
	...
	% Entities
	createGameEntity(EID_0, 'E', mortal, 14, 1, active,  entitySequentialMovement, [appearance(attribs(normal, red, default))]), 
%	createGameEntity(EID_1, 'E', mortal, 10, 7, active, entitySequentialMovement, [appearance(attribs(normal, red, default))]), 
	createGameEntity(EID_2, 'E', mortal, 18, 7, active, entitySequentialMovement, [appearance(attribs(normal, red, default))]),
	entitySequentialMovement(init, EID_0, [ r,r,r,r,n,l,l,l,l,l,l,l,l,n,r,r,r,r ], [ no_repeat_moves ]),
%	entitySequentialMovement(init, EID_1, [ u,u,r,r,r,r,r,r,r,r,d,d,l,l,l,l,l,l,l,l ], [ no_repeat_moves ]),
	entitySequentialMovement(init, EID_2, [ l,l,l,l,l,l,l,l,n,r,r,r,r,r,r,r,r,n ], [ no_repeat_moves ]).
